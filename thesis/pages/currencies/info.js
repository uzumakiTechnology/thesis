...
import CMCPriceConverter from '../../components/CMCBoard/CMCPriceConverter'
import Graph from '../../components/CMCBoard/Graph'
...
const Currencies = () =>{
    ...
    // getting parameter from URLs
    // URL :`/currencies/info?symbol=${coinSymbol}&coin=${coinName}&price=${price}`

    const getURLData = async () =>{
        // window.location used to get the current page address and to redirect the browser to a new page
        const queryString = window.location.search

        const urlParams = new URLSearchParams(queryString);

        setCoinName(urlParams.get('coin')); // coinName
